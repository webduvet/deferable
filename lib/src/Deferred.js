...
var DeferredTrigger = /*#__PURE__*/function (_DeferredPromise) {
  _inherits(DeferredTrigger, _DeferredPromise);
  var _super2 = _createSuper(DeferredTrigger);
  function DeferredTrigger(workload) {
    var _this2;
    _classCallCheck(this, DeferredTrigger);
    _this2 = _super2.call(this, function (resolve, reject) {});
    _this2._workload = workload;
    console.log(_assertThisInitialized(_this2));
    return _this2;
  }
  _createClass(DeferredTrigger, [{
    key: "trigger",
